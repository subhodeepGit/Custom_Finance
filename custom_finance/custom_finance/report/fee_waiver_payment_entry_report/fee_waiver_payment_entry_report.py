...
def get_conditions(filters):
	...
	if filters.get("voucher_no"):
		...
		fee_voucher_no=[]
		for t in fee_waiver_components:
			fee_voucher_no.append(t['fee_voucher_no'])	
		fee_voucher_no = list(set(fee_voucher_no))
		payment_id=[]
		for fees in fee_voucher_no:
			list_of_voucher_no=frappe.db.get_list("Payment Entry Reference",{"reference_name":fees},['name','parent'])
			for t in list_of_voucher_no:
				payment_id.append(t['parent'])
		payment_id=	list(set(payment_id))
		if len(payment_id)==1:	
